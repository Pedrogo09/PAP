...
echo.
echo A sincronizar alteracoes do GitHub (pull remoto)...
:: Alterado: Aceita historicos diferentes e resolve conflitos favorecendo os teus ficheiros locais automaticamente
