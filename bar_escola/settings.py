...
AXES_COOLOFF_TIME = 2  # minutes (reduzido para testes da PAP)
AXES_LOCKOUT_TEMPLATE = 'bar_app/lockout.html'
AXES_RESET_ON_SUCCESS = True  # Desbloqueia após login bem-sucedido
AXES_LOCK_OUT_BY_COMBINATION_USER_AND_IP = True  # Bloqueio por IP + utilizador
